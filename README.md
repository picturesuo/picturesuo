...
- Creating research-based practical tools 
- Trying to materialize my imagination into useful products 

## Some examples

- [Pretick](https://github.com/picturesuo/pretick) - Platform that provides a new model for investing in both stocks as well as prediction markets. 
...
- [CS50 First Ever Project](https://github.com/picturesuo/CS50-first-ever-project) - Hello world! (which I didn't end up documenting correctly)

## Currently

Building an ideation machine to give structure and reality checks to people's ideas
